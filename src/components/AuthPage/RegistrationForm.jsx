            ...
            <div class="container max-w-screen-lg mx-auto">
                ...
                <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                    ...
                    <div class="text-gray-600">
                        <p class="font-medium text-xl text-green-700">Personal Details</p>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" name='fullname' type="text" />
                        </div>

                        <div class="md:col-span-3">
                            <label for="email">Email Address</label>
                            <input type="text" name="email"  class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  placeholder="email@domain.com" />
                        </div>
                        <div class="md:col-span-3">
                            <label for="tel">Phone No</label>
                            <input type="tel" name="full_name" id="full_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  />
                        </div>
                        <div class="md:col-span-2">
                ...
                <image src="https://www.buymeacoffee.com/assets/img/guidelines/logo-mark-3.svg" alt="Buy Me A Coffee" class="transition-all rounded-full w-14 -rotate-45 hover:shadow-sm shadow-lg ring hover:ring-4 ring-white"/>
                </a>
            </div>
            </div>
        </form>
